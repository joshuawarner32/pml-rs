...
pub enum FileSystemOperation {
    ...
    FastioMdlWriteComplete = 2, // FASTIO_MDL_WRITE_COMPLETE
    WriteFile2 = 3, // FASTIO_PREPARE_MDL_WRITE
    FastioMdlReadComplete = 4, // FASTIO_MDL_READ_COMPLETE
    ReadFile2 = 5, // FASTIO_MDL_READ
    QueryOpen = 6, // FASTIO_NETWORK_QUERY_OPEN
    FastioCheckIfPossible = 7, // FASTIO_CHECK_IF_POSSIBLE
    IrpMj12 = 8, // IRP_MJ_12
    IrpMj11 = 9, // IRP_MJ_11
    IrpMj10 = 10, // IRP_MJ_10
    IrpMj9 = 11, // IRP_MJ_9
    IrpMj8 = 12, // IRP_MJ_8
    FastioNotifyStreamFoCreation = 13, // FASTIO_NOTIFY_STREAM_FO_CREATION
    FastioReleaseForCcFlush = 14, // FASTIO_RELEASE_FOR_CC_FLUSH
    FastioAcquireForCcFlush = 15, // FASTIO_ACQUIRE_FOR_CC_FLUSH
    FastioReleaseForModWrite = 16, // FASTIO_RELEASE_FOR_MOD_WRITE
    FastioAcquireForModWrite = 17, // FASTIO_ACQUIRE_FOR_MOD_WRITE
    FastioReleaseForSectionSynchronization = 18, // FASTIO_RELEASE_FOR_SECTION_SYNCHRONIZATION
